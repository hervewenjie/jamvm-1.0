...
void initialiseMainThread(int stack_size) {
    Class *thrdGrp_class;                // java.lang.ThreadGroup
//    FieldBlock *vmData;
    ...
    // find fields in java.lang.Thread
//    vmData = findField(thread_class, "vmData", "I");                       // vmData
    daemon = findField(thread_class, "daemon", "Z");                       // daemon
    name = findField(thread_class, "name", "Ljava/lang/String;");          // name
    group = findField(thread_class, "group", "Ljava/lang/ThreadGroup;");   // group
    priority = findField(thread_class, "priority", "I");                   // priority
...
//        goto error;
//    }
    if( (run == NULL) || (daemon == NULL) || (name == NULL) ||
